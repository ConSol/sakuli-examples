...
var testCase = new TestCase(100, 150);
...
try {
    ...
    testCase.endOfStep("Test Sahi landing page", 50, 60, forward=true);
    ...
    testCase.saveResult(forward=true);
}
